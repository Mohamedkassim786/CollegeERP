                    ...
                    <tbody className="divide-y divide-gray-100">
                      {facultyList.map((f) => (
                        <tr key={f.id} className="hover:bg-gray-50">
                          ...
                          <td className="p-4">
                            {f.isDisabled ? (
                              <span className="px-2 py-1 bg-red-100 text-red-700 rounded-full text-[10px] font-black uppercase tracking-wider border border-red-200">
                                Disabled
                              </span>
                            ) : (
                              <span className="px-2 py-1 bg-emerald-100 text-emerald-700 rounded-full text-[10px] font-black uppercase tracking-wider border border-emerald-200">
                                Active
                              </span>
                            )}
                          </td>
                          <td className="p-4 text-sm text-gray-600">
                            {f.lastLogin
                              ? new Date(f.lastLogin).toLocaleString()
                              : "Never"}
                          </td>
                          <td className="p-4">
                            <div className="flex justify-end gap-2">
                              ...
                              <button
                                onClick={() =>
                                  handleToggleFaculty(f.id, f.isDisabled)
                                }
