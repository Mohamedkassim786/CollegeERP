          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
            <div>
              ...
              <p className="text-gray-500 font-medium mt-1">
                Submit external marks for assigned subjects using dummy numbers.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {assignments.length > 0 ? (
                assignments.map((assignment) => (
                  <div
                    key={assignment.id}
                    className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all group"
                  >
                    ...
                    <div className="mb-8">
                      <h3 className="text-xl font-black text-[#003B73] mb-2">
                    ...
                    <button
                      onClick={() =>
                        navigate(`/external/marks/${assignment.id}`)
                      }
                ...
                <div className="col-span-full bg-white p-20 rounded-[40px] text-center border-2 border-dashed border-gray-100">
                  ...
                  <p className="text-gray-400 font-medium">
                    You haven't been assigned any mark entry tasks yet.
                  </p>
                </div>
              )}
            </div>
