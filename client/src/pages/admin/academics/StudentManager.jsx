...
import { getDepartments, getSections, createSection } from "../../../services/department.service";
    ...
    try {
      ...
      if (selectedCategory === 'PASSED_OUT') {
        ...
        if (matchingDept) {
          ...
          if (sectionObj) {
            params.semester = sectionObj.semester;
                  ...
                  <div>
                    ...
                    >
                      ...
                      {(newStudent.year === "1"
                        ...
                        : dbSections
                          .filter(s => s.departmentId === departments.find(d => d.code === newStudent.department || d.name === newStudent.department)?.id)
                          .map(s => s.name)
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <div className="col-span-2 md:col-span-1">
                    ...
                    >
                      {(() => {
                        const dept = departments.find(d => d.code === bulkConfig.department || d.name === bulkConfig.department);
                        const degree = dept?.degree || 'B.E.';
                        const options = SEMESTER_OPTIONS[degree] || [1, 2, 3, 4, 5, 6, 7, 8];
