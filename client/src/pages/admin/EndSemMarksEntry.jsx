            ...
            <div className="flex justify-between items-center mb-10">
                <div>
                    ...
                    <p className="text-gray-500 font-medium mt-1">
                        Merge Internal(40) and External(60) and Calculate Grades
                    </p>
                </div>
                <div className="flex gap-4">
                    ...
                    >
                        ...
                        {saving ? "Processing..." : "Calculate & Consolidate"}
                    </button>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                    ...
                    <div className="flex flex-col justify-end">
                        <button
                            ...
                            className="w-full bg-[#003B73] text-white py-4 rounded-2xl hover:bg-blue-800 transition-all font-black shadow-lg shadow-blue-900/20 flex items-center justify-center gap-2 mb-1"
                        >
                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-gray-50">
                        {loading ? (
                            ...
                            <tr>
                                <td
                                    className="px-8 py-32 text-center text-gray-300"
                                    colSpan="6"
                                >
                            ...
                            students.map((s) => (
                                ...
                                >
                                    <td className="px-8 py-6 font-mono text-sm uppercase text-[#003B73] font-bold">
                                        {s.registerNumber}
                                    </td>
                                    ...
                                    <td className="px-8 py-6 text-center">
                                        <span className="bg-blue-50 text-blue-700 px-4 py-2 rounded-xl font-black">
                                            {s.internal40}
                                        </span>
                                    </td>
                                    <td className="px-8 py-6 text-center">
                                        <span className="bg-amber-50 text-amber-700 px-4 py-2 rounded-xl font-black">
                                            {s.external60}
                                        </span>
                                    </td>
                                    <td className="px-8 py-6 text-center">
                                        <span className="bg-[#003B73] text-white px-5 py-2.5 rounded-2xl font-black shadow-lg shadow-blue-900/10 text-lg">
                                            {s.total100}
                                        </span>
                                    </td>
                                    <td className="px-8 py-6 text-center">
                                        <div
                                            className={`inline-block px-5 py-2 rounded-2xl font-black text-sm shadow-sm ${s.grade === "RA" || s.grade === "N/A"
