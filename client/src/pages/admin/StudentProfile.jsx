...
const StudentProfile = () => {
    ...
    const handlePhotoChange = (e) => {
        ...
        if (file) {
            ...
            setEditingStudent({ ...editingStudent, photoFile: file, photo: window.URL.createObjectURL(file) });
        }
    };
    ...
    const handleEditStudent = async (e) => {
        ...
        try {
            ...
            await api.put(`/admin/students/${editingStudent.id}`, formData, { headers: { "Content-Type": "multipart/form-data" } });
    ...
    const handleDownload = async () => {
        try {
            ...
            const res = await api.get(`/exams/grade-sheet?studentId=${id}&semester=${student.semester}`, { responseType: 'blob' });
