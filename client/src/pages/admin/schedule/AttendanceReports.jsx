...
const AttendanceReports = () => {
    ...
    const fetchReport = async () => {
        setLoading(true);
        try {
            const res = await getAdminAttendanceReport({ department, year, semester, section, fromDate, toDate });
    ...
    const exportToExcel = async () => {
        ...
        setExporting(true);
        try {
            const response = await exportAttendanceExcel({ department, year, semester, section, fromDate, toDate });
