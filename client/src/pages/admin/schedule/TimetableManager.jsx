...
import { 
  getTimetable, 
  saveTimetable, 
  getFacultyAbsences as getTimetableAbsences, 
  markFacultyAbsent as markTimetableAbsent, 
  deleteFacultyAbsence as deleteTimetableAbsence, 
  getSubstitutions as getTimetableSubstitutions, 
  assignSubstitute, 
  deleteSubstitution, 
...
const TimetableManager = () => {
  ...
  const fetchDailyStatus = async () => {
    ...
    try {
      ...
      const [absRes, subRes] = await Promise.all([
        getTimetableAbsences(selectedDate),
        getTimetableSubstitutions(selectedDate),
      ]);
  ...
  const fetchAvailability = async (date, period) => {
    ...
    try {
      const res = await getFacultyAvailability(date, period);
