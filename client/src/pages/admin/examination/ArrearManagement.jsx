...
import { getArrears, uploadArrears, autoGenerateArrears, deleteArrear } from "../../../services/arrear.service";
...
const ArrearManagement = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await uploadArrears(formData);
  ...
  const handleSyncArrears = async () => {
    ...
    try {
      ...
      const res = await autoGenerateArrears(sem);
